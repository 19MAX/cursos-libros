...
<?= $this->section('title') ?>Editar Documento<?= $this->endSection() ?>
<?= $this->section('page_title') ?>Editar Documento<?= $this->endSection() ?>
<?= $this->section('page_description') ?>Modifica la información del documento<?= $this->endSection() ?>
<?= $this->section('breadcrumb') ?>Documentos / Editar<?= $this->endSection() ?>
...
<div class="admin-card">
    <div class="admin-card-header">
        <h3 class="text-lg font-semibold admin-text-primary">Editar Documento</h3>
        <p class="admin-text-secondary text-sm">Modifica la información del documento</p>
    </div>
    <div class="admin-card-body">
        <form action="<?= base_url('docente/documentos/update/' . $documento['id']) ?>" method="post" enctype="multipart/form-data">
            <?= csrf_field() ?>
            ...
            <div class="admin-form-row">
                <div class="admin-form-group">
                    ...
                    <input type="text" id="nombre" name="nombre" 
                           value="<?= old('nombre', $documento['nombre']) ?>" class="admin-input" 
            ...
            <div class="admin-form-row">
                <div class="admin-form-group">
                    ...
                    <textarea id="descripcion" name="descripcion" rows="4" class="admin-textarea" 
                              placeholder="Describe el contenido y propósito del documento..."><?= old('descripcion', $documento['descripcion']) ?></textarea>
            ...
            <div class="admin-form-row">
                <div class="admin-form-group">
                    <label for="guia" class="admin-label">
                        <ion-icon name="document-outline" class="w-4 h-4 mr-2"></ion-icon>
