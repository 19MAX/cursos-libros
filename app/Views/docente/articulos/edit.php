            ...
            <div class="admin-form-row">
                <div class="admin-form-group">
                    ...
                    <select name="area_conocimiento" id="area_conocimiento" class="admin-select">
                        ...
                        <option value="CIENCIAS NATURALES" <?= old('area_conocimiento', $articulo['area_conocimiento']) == 'CIENCIAS NATURALES' ? 'selected' : '' ?>>CIENCIAS
                            NATURALES</option>
                        <option value="CIENCIAS FORMALES Y APLICADAS" <?= old('area_conocimiento', $articulo['area_conocimiento']) == 'CIENCIAS FORMALES Y APLICADAS' ? 'selected' : '' ?>>
                            CIENCIAS FORMALES Y APLICADAS</option>
                        <option value="INGENIERÍA Y TECNOLOGÍA" <?= old('area_conocimiento', $articulo['area_conocimiento']) == 'INGENIERÍA Y TECNOLOGÍA' ? 'selected' : '' ?>>INGENIERÍA Y
                            TECNOLOGÍA</option>
                        <option value="CIENCIAS SOCIALES" <?= old('area_conocimiento', $articulo['area_conocimiento']) == 'CIENCIAS SOCIALES' ? 'selected' : '' ?>>CIENCIAS SOCIALES
                        </option>
                        <option value="CIENCIAS ECONÓMICAS Y ADMINISTRATIVAS" <?= old('area_conocimiento', $articulo['area_conocimiento']) == 'CIENCIAS ECONÓMICAS Y ADMINISTRATIVAS' ? 'selected' : '' ?>>CIENCIAS ECONÓMICAS Y ADMINISTRATIVAS</option>
                        <option value="CIENCIAS DE LA SALUD Y MEDICINA" <?= old('area_conocimiento', $articulo['area_conocimiento']) == 'CIENCIAS DE LA SALUD Y MEDICINA' ? 'selected' : '' ?>>
                            CIENCIAS DE LA SALUD Y MEDICINA</option>
                        <option value="HUMANIDADES" <?= old('area_conocimiento', $articulo['area_conocimiento']) == 'HUMANIDADES' ? 'selected' : '' ?>>HUMANIDADES</option>
                        <option value="ARTES Y COMUNICACIÓN" <?= old('area_conocimiento', $articulo['area_conocimiento']) == 'ARTES Y COMUNICACIÓN' ? 'selected' : '' ?>>ARTES Y
                            COMUNICACIÓN</option>
                        <option value="INTERDISCIPLINARIAS Y EMERGENTES" <?= old('area_conocimiento', $articulo['area_conocimiento']) == 'INTERDISCIPLINARIAS Y EMERGENTES' ? 'selected' : '' ?>>
                            INTERDISCIPLINARIAS Y EMERGENTES</option>
                    </select>
                </div>
                <div class="admin-form-group">
                    ...
                    <select name="disciplina" id="disciplina" class="admin-select">
                        ...
                        <option value="CIENCIAS NATURALES" <?= old('disciplina', $articulo['disciplina']) == 'CIENCIAS NATURALES' ? 'selected' : '' ?>>CIENCIAS NATURALES</option>
                        <option value="CIENCIAS FORMALES Y APLICADAS" <?= old('disciplina', $articulo['disciplina']) == 'CIENCIAS FORMALES Y APLICADAS' ? 'selected' : '' ?>>CIENCIAS
                            FORMALES Y APLICADAS</option>
                        <option value="INGENIERÍA Y TECNOLOGÍA" <?= old('disciplina', $articulo['disciplina']) == 'INGENIERÍA Y TECNOLOGÍA' ? 'selected' : '' ?>>INGENIERÍA Y
                            TECNOLOGÍA</option>
                        <option value="CIENCIAS SOCIALES" <?= old('disciplina', $articulo['disciplina']) == 'CIENCIAS SOCIALES' ? 'selected' : '' ?>>CIENCIAS SOCIALES</option>
                        <option value="CIENCIAS ECONÓMICAS Y ADMINISTRATIVAS" <?= old('disciplina', $articulo['disciplina']) == 'CIENCIAS ECONÓMICAS Y ADMINISTRATIVAS' ? 'selected' : '' ?>>
                            CIENCIAS ECONÓMICAS Y ADMINISTRATIVAS</option>
                        <option value="CIENCIAS DE LA SALUD Y MEDICINA" <?= old('disciplina', $articulo['disciplina']) == 'CIENCIAS DE LA SALUD Y MEDICINA' ? 'selected' : '' ?>>CIENCIAS DE
                            LA SALUD Y MEDICINA</option>
                        <option value="HUMANIDADES" <?= old('disciplina', $articulo['disciplina']) == 'HUMANIDADES' ? 'selected' : '' ?>>HUMANIDADES</option>
                        <option value="ARTES Y COMUNICACIÓN" <?= old('disciplina', $articulo['disciplina']) == 'ARTES Y COMUNICACIÓN' ? 'selected' : '' ?>>ARTES Y COMUNICACIÓN</option>
                        <option value="INTERDISCIPLINARIAS Y EMERGENTES" <?= old('disciplina', $articulo['disciplina']) == 'INTERDISCIPLINARIAS Y EMERGENTES' ? 'selected' : '' ?>>
                            INTERDISCIPLINARIAS Y EMERGENTES</option>
                    </select>
                </div>
            </div>
                ...
                <div class="admin-form-group">
                    ...
                    <?php if (!empty($articulo['archivo_articulo'])): ?>
                        <div class="mt-1 text-xs">Actual: <a
                                href="<?= base_url('uploads/' . $articulo['archivo_articulo']) ?>" target="_blank">Ver
                                archivo</a></div>
                    <?php endif; ?>
                ...
                <div class="admin-form-group">
                    ...
                    <?php if (!empty($articulo['portada_articulo'])): ?>
                        <div class="mt-1 text-xs">Actual: <img
                                src="<?= base_url('uploads/' . $articulo['portada_articulo']) ?>" alt="Portada"
