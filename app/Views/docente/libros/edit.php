...
<div class="admin-card">
    ...
    <div class="admin-card-body">
        <form action="<?= base_url('docente/libros/update/' . $libro['id']) ?>" method="post"
            ...
            <div class="admin-form-row">
                <div class="admin-form-group">
                    ...
                    <input type="text" id="titulo_libro" name="titulo_libro"
                        value="<?= old('titulo_libro', $libro['titulo_libro']) ?>" class="admin-input" required>
                </div>
                <div class="admin-form-group">
                    ...
                    <input type="text" id="doi" name="doi" value="<?= old('doi', $libro['doi'] ?? '') ?>"
            ...
            <div class="admin-form-row">
                <div class="admin-form-group">
                    ...
                    <input type="text" id="autores" name="autores" value="<?= old('autores', $libro['autores']) ?>"
                ...
                <div class="admin-form-group">
                    ...
                    <input type="text" id="editorial" name="editorial"
                        value="<?= old('editorial', $libro['editorial']) ?>" class="admin-input" required>
                </div>
            </div>
            <div class="admin-form-row">
                <div class="admin-form-group">
                    ...
                    <select id="tipo_libro" name="tipo_libro" class="admin-select" required>
                        ...
                        <option value="otros" <?= old('tipo_libro', $libro['tipo_libro']) == 'otros' ? 'selected' : '' ?>>
                            Otros</option>
                    </select>
                </div>
                <div class="admin-form-group">
            ...
            <div class="admin-form-row">
                <div class="admin-form-group">
                    ...
                    <input type="number" id="citas_referenciadas" name="citas_referenciadas"
                        value="<?= old('citas_referenciadas', $libro['citas_referenciadas'] ?? 0) ?>"
                        class="admin-input" min="0" required>
                    <p class="admin-text-secondary text-sm mt-1">Número de veces que el libro ha sido citado (0 si no
                        aplica).</p>
                </div>
                <div class="admin-form-group">
                    ...
                    <input type="date" id="fecha_publicacion" name="fecha_publicacion"
                        value="<?= old('fecha_publicacion', $libro['fecha_publicacion']) ?>" class="admin-input"
                        required>
                </div>
            </div>
            <div class="admin-form-row">
                <div class="admin-form-group">
                    ...
                    <?php if (!empty($libro['archivo_libro'])): ?>
                        <a href="<?= getLibroFile($libro['archivo_libro']) ?>" target="_blank"
                            class="admin-btn-secondary text-xs mb-2">
                    ...
                    <input type="file" id="archivo_libro" name="archivo_libro" accept="application/pdf"
                        class="admin-file-input mt-1">
                    <p class="admin-text-secondary text-sm mt-1">Dejar vacío para no cambiar el archivo. Solo PDF. Máx.
                        20MB.</p>
                </div>
                <div class="admin-form-group">
                    ...
                    <?php if (!empty($libro['portada_libro'])): ?>
                        <img src="<?= getLibroFile($libro['portada_libro']) ?>" alt="Portada actual"
                            class="h-16 w-12 object-cover rounded shadow mb-2" />
                    <?php endif; ?>
                    <input type="file" id="portada_libro" name="portada_libro" accept="image/*"
                        class="admin-file-input mt-1">
                    <p class="admin-text-secondary text-sm mt-1">Dejar vacío para no cambiar la portada. Solo imágenes.
                        Máx. 5MB.</p>
                </div>
            </div>
            <div class="admin-form-row">
                <div class="admin-form-group">
                    ...
                    <?php if (!empty($libro['proceso_pares'])): ?>
                        <a href="<?= getLibroFile($libro['proceso_pares']) ?>" target="_blank"
                            class="admin-btn-secondary text-xs mb-2">
                            <ion-icon name="eye-outline" class="w-4 h-4 mr-1"></ion-icon>
                            Ver archivo actual
                        </a>
